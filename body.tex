...
There are no simple answers to these question\vmadd{s}, because they will vary depending
...
likelihood is raised to \vmadd{a} power (annealing).
This approach provides an estimator of the marginal likelihood that is unbiased
from both a statistical and computational perspective \vmcomment{Not sure I know what unbiased means from a computational perspective}.
...
\jroedit{}{
\begin{linenomath}
Another\vmadd{, albeit not an unrelated,} way to compare models is based on their predictive power, with the idea
...
by simply taking the average probability of the testing data \vmcomment{not clear how testing data are obtained} across the
...
based \vmadd{on} marginal likelihoods \citep{Lartillot2006} and cross validation that
