...
\thought{The rescaling of the GLM could be dataset specific, making the
    marginal likelihoods difficult to compare with ``true'' ML of the
    sequences. A solution is to compare the ratios of MLs (Bayes factors)
    estimated by ABC-GLM and quadrature integration. Then, even if MLs across
    datasets are not comparable, the relative MLs for each dataset will be.
    Could easily compare JC to K2P.}
