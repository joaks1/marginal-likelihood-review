...
Learning about evolutionary patterns and processes by Bayesian comparison of
...
choice\jroedit{}{, which} is based on comparing the maximum probability of the
...
with the latter usually \emph{much} more peaked than the former \jro{}{due to
    the strong influence of the likelihood}.
