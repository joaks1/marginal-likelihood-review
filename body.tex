...
from the posterior sample \citep{Newton1994}, an often used importance-sampling
approximation of the marginal likelihood.
Both of these techniques suffer
...
\jrocomment{Thanks. I've updated the language.}
