...
Both of these techniques \vmdel{are} \vmadd{can be thought of as} importance-sampling \vmadd{integral} approximations, and suffer
...
If we integrate the \vmadd{posterior expectation of the  derivative with respect to $\beta$ of the log power posterior} 
