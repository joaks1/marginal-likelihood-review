...
% mbox necessary to allow strikeout through citations
\jroeditb{
If two highly dissimilar models need to be compared,
\mbox{\citet{Lartillot2006}} introduced a method of using
path sampling to directly approximate the Bayes factor.
Similarly, \mbox{\citet{Baele2013}} extended the stepping-stone
approach of \mbox{\citet{Xie2011}} to do the same.
