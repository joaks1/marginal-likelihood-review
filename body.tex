...
\jroedit{}{
This pedagogical example is somewhat contrived given that the models we are
comparing are simply different priors.
...
\citet{Lartillot2006} introduced path sampling \citep{Gelman1998}
...
partitioning aligned characters to substitution models.
